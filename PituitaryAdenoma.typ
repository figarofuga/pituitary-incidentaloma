...
• JAMAのReviewだと、検査はまずは迅速ACTH試験、中枢性TSH欠乏の確認、次に中枢性Hypogonadismを推奨。GH欠乏は下垂体腺腫の治療が終わり他のホルモン補充が終わったあとまでは検査しない事を推奨。
  • 中枢性副腎不全central adrenal insufficiency (adrenocorticotropin hormone [ACTH] deficiency)
    ○ 中枢性副腎不全
      • まずは、8-9時の血清Cortisolを測定する
        ...
        ○ 原発性副腎不全と二次性副腎不全の鑑別のためにReninとAldosteroneの採血が推奨される。Aldosterone採血の時は2時間以上患者を臥位にする。aldosterone低値 (< 70 pmol/L [2.53 ng/dL]) に加えて高renin concentrations (> 3.24 ng/mL/hour) は原発性副腎不全を疑う。
